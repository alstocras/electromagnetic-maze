...
## The name of this plugin as it should be displayed.
const PLUGIN_NAME := "NovaTools"

## The name of this plugin when checking if it's enabled.
const PLUGIN_NAME_INTERNAL := "novatools"
...
func _enter_tree() -> void:
	if get_editor_interface().is_plugin_enabled(PLUGIN_NAME_INTERNAL):
		_enable_plugin()
